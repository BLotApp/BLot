...
RenderingManager::~RenderingManager() { cleanup(); }
...
std::shared_ptr<IRenderer> RenderingManager::createRenderer(entt::entity entity,
															RendererType type,
															int width,
															int height) {
...
void RenderingManager::addCanvas(entt::entity entity,
...
void RenderingManager::addGraphics(entt::entity entity,
