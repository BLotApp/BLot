...
public:
    ...
    void setShadow(float x, float y, float blur, float r, float g, float b, float a = 1.0f);
    void setGradient(float x1, float y1, float r1, float g1, float b1, 
    ...
    // Image operations
    void drawImage(const std::string& imagePath, float x, float y, float width = 0, float height = 0);
