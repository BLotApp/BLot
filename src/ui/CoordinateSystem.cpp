...
CoordinateSystem::CoordinateSystem() 
    ...
    , m_appPos(0, 0)
    , m_appSize(0, 0)
    , m_canvasWindowPos(0, 0)
    , m_canvasWindowSize(0, 0)
...
void CoordinateSystem::setCanvasWindow(float x, float y, float width, float height) {
...
glm::vec2 CoordinateSystem::transform(glm::vec2 point, CoordinateSpace from, CoordinateSpace to) {
...
CoordinateSystem::CoordinateInfo CoordinateSystem::getCoordinateInfo(glm::vec2 mousePos, CoordinateSpace space) {
    CoordinateInfo info;
    info.mouse = mousePos;
...
glm::vec2 CoordinateSystem::getScreenSize() const {
    return m_screenSize;
}

glm::vec2 CoordinateSystem::getAppWindowSize() const {
    return m_appSize;
}
