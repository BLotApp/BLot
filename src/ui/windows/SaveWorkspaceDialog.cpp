...
void SaveWorkspaceDialog::render() {
    if (!m_isOpen) return;

    ImGui::SetNextWindowSize(ImVec2(400, 150), ImGuiCond_FirstUseEver);
    
    if (ImGui::Begin("Save Workspace", &m_isOpen, ImGuiWindowFlags_NoCollapse)) {
        ...
        if (ImGui::InputText("##WorkspaceName", m_nameBuffer, sizeof(m_nameBuffer), 
