...
void CodeEditorWindow::setOnCodeChanged(std::function<void(const std::string&)> callback) {
...
void CodeEditorWindow::renderStatusBar() {
    ImGui::Separator();
    ImGui::Text("Language: %s | Lines: %d", m_language.c_str(), m_editor->GetTotalLines());
}
