...
void ThemeEditorWindow::renderThemeEditor() {
    ...
    if (ImGui::Combo("Theme", &currentTheme, themes, IM_ARRAYSIZE(themes))) {
        ...
        m_uiManager->m_currentTheme = static_cast<UIManager::ImGuiTheme>(currentTheme);
    }
    ...
    // Main colors
    if (ImGui::CollapsingHeader("Main Colors", ImGuiTreeNodeFlags_DefaultOpen)) {
    ...
    // Frame colors
    if (ImGui::CollapsingHeader("Frame Colors", ImGuiTreeNodeFlags_DefaultOpen)) {
    ...
    if (ImGui::CollapsingHeader("Title Bar Colors")) {
        ...
        ImGui::ColorEdit4("Title Background Collapsed", (float*)&colors[ImGuiCol_TitleBgCollapsed]);
    }
    
    // Button colors
    if (ImGui::CollapsingHeader("Button Colors", ImGuiTreeNodeFlags_DefaultOpen)) {
    ...
    if (ImGui::CollapsingHeader("Tab Colors")) {
        ...
        ImGui::ColorEdit4("Tab Unfocused Active", (float*)&colors[ImGuiCol_TabUnfocusedActive]);
    }
    ...
    if (ImGui::CollapsingHeader("Other Colors")) {
        ...
        ImGui::ColorEdit4("Navigation Highlight", (float*)&colors[ImGuiCol_NavHighlight]);
        ImGui::ColorEdit4("Modal Window Dim Background", (float*)&colors[ImGuiCol_ModalWindowDimBg]);
    }
    ...
    if (ImGui::SliderFloat2("Window Padding", (float*)&windowPadding, 0.0f, 20.0f)) {
        style.WindowPadding = windowPadding;
    }
    
    ImVec2 framePadding = style.FramePadding;
    if (ImGui::SliderFloat2("Frame Padding", (float*)&framePadding, 0.0f, 20.0f)) {
