...
void EventSystem::registerEvent(const std::string &eventId,
...
void EventSystem::registerAction(
...
entt::entity
EventSystem::createListener(const std::string &eventId,
...
void EventSystem::createEmitter(entt::entity entity,
