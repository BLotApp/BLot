...
class ECSManager : public IManager, public ISettings {
  public:
	...
	void runCanvasRenderSystem(RenderingManager *renderingManager,
	...
	const systems::EventSystem &getEventSystem() const {
...
template <typename T> T &ECSManager::getComponent(entt::entity entity) {
	return m_registry.get<T>(entity);
}

template <typename T> bool ECSManager::hasComponent(entt::entity entity) {
	return m_registry.all_of<T>(entity);
}

template <typename T> void ECSManager::removeComponent(entt::entity entity) {
	m_registry.remove<T>(entity);
}

template <typename... Components> auto ECSManager::view() {
