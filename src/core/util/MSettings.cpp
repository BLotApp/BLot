...
bool MSettings::saveSettings(const blot::json &settings) {
...
bool MSettings::loadSettings(blot::json &outSettings) {
	std::string settingsFile = AppPaths::getUserSettingsFile();
...
blot::json MSettings::getSettings() const {
...
void MSettings::setSettings(const blot::json &settings) {
