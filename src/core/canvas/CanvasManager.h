...
public:
    ...
    std::shared_ptr<Canvas> createCanvas(const CanvasSettings& settings, const std::string& name = "");
    // [Optionally: keep old overloads for backward compatibility, but mark as deprecated]
