...
bxBlend2DAddon::bxBlend2DAddon()
	: AddonBase("bxBlend2D", "1.0.0") {}

bxBlend2DAddon::~bxBlend2DAddon() { cleanup(); }

bool bxBlend2DAddon::init() {
	spdlog::info("[bxBlend2DAddon] Initializing and registering Blend2D renderer factory");
...
void bxBlend2DAddon::registerRendererFactory() {
	...
	RendererRegistry::instance().registerFactory(RendererType::Blend2D, createBlend2DRenderer);
}
